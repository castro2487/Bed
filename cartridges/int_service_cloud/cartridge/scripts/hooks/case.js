...
function handleExport(caseObj) {
    try {
        ...
        var requestPayload = JSON.stringify(sccCaseModel);
        var serviceResponse = svc.call(ServiceMgr.restEndpoints.create.case, requestPayload)

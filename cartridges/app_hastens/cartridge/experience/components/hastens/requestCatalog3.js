...
module.exports.render = RenderHelper.renderStandardComponentWithContext('RequestCatalog3', function(context) {
    return {
        text: {
            bannerHeading: context.content.bannerHeading,
            afterBannerHeading: context.content.afterBannerHeading,
            bannerBody: context.content.bannerBody ? context.content.bannerBody.value : '',

...
server.replace(
    ...
    function (req, res, next) {
        ...
        var registrationFormObj = {
            ...
            prefixCountry: registrationForm.customer.prefixCountry.value,
            prefix: registrationForm.customer.prefix.value,
            phone: registrationForm.customer.phone.value,
            email: registrationForm.customer.email.value,
            emailConfirm: registrationForm.customer.emailconfirm.value,
            password: registrationForm.login.password.value,
            passwordConfirm: registrationForm.login.passwordconfirm.value,
            addtoemaillist: registrationForm.customer.addtoemaillist.checked,            
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                if (registrationForm.validForm) {
                    ...
                    if(customerByLogin) {
                        ...
                        registrationForm.form.customer.email.error = Resource.msg('error.message.customer-already-registered', 'forms', null);
                    } else {
                        ...
                        try {
                            Transaction.wrap(function () {
                                ...
                                if (!authenticatedCustomer) {
                                    ...
                                    newCustomerProfile.custom.prefix = registrationForm.prefix;
                                    newCustomerProfile.custom.prefixCountry = registrationForm.prefixCountry.toUpperCase();
                                    newCustomerProfile.phoneHome = registrationForm.prefix + registrationForm.phone;
                                    newCustomerProfile.email = registrationForm.email;
                                    newCustomerProfile.custom.newsLetterRegistration = registrationForm.addtoemaillist;
                                }
                            });
                        } catch (e) {
                            if (e.authError) {
...
server.replace(
    ...
    function (req, res, next) {
        ...
        if (accountModel.profile.prefix) {
            profileForm.customer.prefix.value = accountModel.profile.prefix;
            profileForm.customer.prefixCountry.value = accountModel.profile.prefixCountry;
        } else {
            var currentCountry = Locale.getLocale(req.locale.id).country;
            profileForm.customer.prefix.value = prefixes[currentCountry];
            profileForm.customer.prefixCountry.value = currentCountry;
        }
        profileForm.customer.phone.value = accountModel.profile.phone;
        profileForm.customer.email.value = accountModel.profile.email;
        profileForm.customer.addtoemaillist.checked = accountModel.profile.newsLetterRegistration;
        res.render('account/profile', {
            profileForm: profileForm,
            prefixes: prefixes,
            countryNames: countryNames,
            privacyPolicyUrl: URLUtils.url('Search-Show', 'cgid', 'privacy-policy'),
            breadcrumbs: [
                {
...
server.replace(
    ...
    function (req, res, next) {
        ...
        var result = {
            ...
            prefixCountry: profileForm.customer.prefixCountry.value,
            prefix: profileForm.customer.prefix.value,
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                if (customerLogin) {
                    Transaction.wrap(function () {
                        ...
                        profile.custom.prefixCountry = formInfo.prefixCountry.toUpperCase();
                        profile.custom.prefix = formInfo.prefix;
                        profile.setPhoneHome(formInfo.prefix + formInfo.phone);
                        profile.custom.newsLetterRegistration = formInfo.profileForm.customer.addtoemaillist.checked;
                    });
...
// // From plugin_wishlist cartridge
...
// Prevent access to Edit Password if online shopping is not enabled in the customer's country
...
// Prevent access to Edit Profile if online shopping is not enabled in the customer's country
...
// Prevent access to Account if online shopping is not enabled in the customer's country

...
export const PortraitBlockTwo: React.FC<RestoreSignupContent> = ({ image, text, mailto }) => {
    const [showForm, setShowForm] = React.useState(false);

    return (
        <section className="has-restore-signup__portrait-2">

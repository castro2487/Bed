...
module.exports = function () {
    ...
    $('.search-desktop .close-button').on('click', function () {
        hideDesktopSearch();
    });

    $('.search-mobile .close-button').on('click', function () {
        hideMobileSearch();
    });

    // Display search input field
    $('.search-desktop').on('click', '.search-toggle', function () {
        showDesktopSearch();
    });

    // Toggle mobile search field
    $('.search-mobile').on('click', '.search-toggle', function () {
        showMobileSearch();
    });
};
